...
// Device attributes
// IotAgent decline attribute with UnitMeta, so once commented-out.
var (
	CpuUsage = DeviceAttribute{
		ObjectID: "cu",
		Name:     "CpuUsage",
		Type:     TypePercentage,
		//		UnitMeta: &UnitMetadata{UnitCode: UcPercentage},
	}

	DiskUsage = DeviceAttribute{
		ObjectID: "du",
		Name:     "DiskUsage",
		Type:     TypePercentage,
		//		UnitMeta: &UnitMetadata{UnitCode: UcPercentage},
	...
	LoadAverage1 = DeviceAttribute{
		ObjectID: "la1",
		Name:     "LoadAverage1",
		Type:     TypeFloat,
	}

	LoadAverage5 = DeviceAttribute{
		ObjectID: "la5",
		Name:     "LoadAverage5",
		Type:     TypeFloat,
	}

	LoadAverage15 = DeviceAttribute{
		ObjectID: "la15",
		Name:     "LoadAverage15",
		Type:     TypeFloat,
	}

	Processes = DeviceAttribute{
		ObjectID: "ps",
		Name:     "Processes",
		Type:     TypeInteger,
	}

	Uptime = DeviceAttribute{
		ObjectID: "ut",
		Name:     "Uptime",
		Type:     TypeInteger,
	}
